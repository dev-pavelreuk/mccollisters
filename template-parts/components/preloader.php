 ...
 *
 * A brand-blue overlay with the McCollister's "M" mark in white, pulsing with
 * a slow heartbeat until the page has loaded, then fading out and being removed.
 ...
 * flash. The mark SVG is the site's M-Traced-solid mark, knocked out in white so
 * the loader matches the site icon (white M on brand blue).
 *
...
<div id="mcc-preloader" class="mcc-preloader" role="status" aria-label="<?php esc_attr_e('Loading', 'mccollisters'); ?>">
    <svg class="mcc-preloader__logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 181.7 137.82" fill="#FFFFFF" aria-hidden="true" focusable="false">
