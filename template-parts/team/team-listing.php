<?php
/**
 * The Our Team listing: "Powered by People" header, founder quote, the
 * `team_member` posts grouped by the `team_group` taxonomy (Executives,
 * Division Leaders, ...), then the shared "More About" cards and CTA.
 *
 * Shared by two routes so they can't drift apart:
 *   - archive-team_member.php  -> /leadership/ (the CPT archive; what the
 *     "Back to Our Team" button on a member page links to)
 *   - page-our-team.php        -> the "Page - Our Team" template
 *
